...
mod tests {
    ...
    fn test_document() -> Document {
        Document::from(include_str!("../test_data/heckoffnerd-1772.html"))
    }

    fn missing_info_document() -> Document {
        Document::from(include_str!("../test_data/Tucker-1475.html"))
    }

    fn competitive_document() -> Document {
        Document::from(include_str!("../test_data/Ichi-21148.html"))
    }
